...
test-vagrant:
	...
	testinfra --hosts=elasticsearch_trusty --ssh-config=.vagrant/ssh-config --noconftest --sudo
	testinfra --hosts=elasticsearch_xenial --ssh-config=.vagrant/ssh-config --noconftest --sudo
